...
export const metadata: Metadata = {
    title: "Dharohar (धरोहर) - History Special | Rajashree IAS Portal",
    description: "Comprehensive History module covering Ancient, Medieval, Modern and World History for UPSC CSE. 50-day intensive program with expert faculty.",
    keywords: "Dharohar, History Special, UPSC History, History module, Ancient History, Medieval History, Modern History",
};

const course = coursesData.courses.find(c => c.id === "dharohar")!;

const courseHighlights = course.courseHighlights.map((highlight, index) => ({
    icon: [ScrollText, FileText, Map, Clock, Brain, Target][index] || ScrollText,
            ...
            <div className="bg-gradient-to-b from-white to-[#FAF9F6] pt-8 pb-12">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex items-center gap-2 text-sm text-[#2D1B33]/60 mb-8">
                        ...
                        <span>/</span>
                        <span className="text-[#2D1B33]">Dharohar</span>
                    </div>
                    ...
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                            <div className="bg-white rounded-xl p-4 shadow-sm border border-[#2D1B33]/10">
                                ...
                                <div className="text-sm text-[#2D1B33]/60">Days Duration</div>
                            </div>
                            <div className="bg-white rounded-xl p-4 shadow-sm border border-[#2D1B33]/10">
                            ...
                            <div className="bg-white rounded-xl p-4 shadow-sm border border-[#2D1B33]/10">
                                <div className="text-2xl font-bold text-[#2D1B33]">6 Months</div>
                                <div className="text-sm text-[#2D1B33]/60">Validity</div>
                            </div>
                        </div>
