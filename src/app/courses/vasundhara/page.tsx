...
export const metadata: Metadata = {
    title: "Vasundhara (वसुंधरा) - Geography + Environment | Rajashree's IAS Portal",
    description: "Complete Geography and Environment module covering physical, human geography and environmental studies for UPSC & MPSC preparation.",
};

export default function VasundharaCoursePage() {
    const course = coursesData.courses.find(c => c.id === "vasundhara");
