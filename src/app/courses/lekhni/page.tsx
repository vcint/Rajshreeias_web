...
export const metadata: Metadata = {
    title: "Answer Writing – Lekhni (लेखनी) | Rajashree's IAS Portal",
    description: "Daily answer writing practice program to master Mains answer writing skills with personalized feedback for UPSC & MPSC exams.",
};

export default function LekhniCoursePage() {
    const course = coursesData.courses.find(c => c.id === "lekhni");
