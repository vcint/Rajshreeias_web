...
export const metadata: Metadata = {
    title: "Dharohar (धरोहर) - History Special | Rajashree's IAS Portal",
    description: "Comprehensive History module covering Ancient, Medieval, Modern and World History for UPSC & MPSC preparation. Expert faculty, structured curriculum.",
};

export default function DharoharCoursePage() {
