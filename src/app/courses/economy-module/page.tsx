...
export const metadata: Metadata = {
    title: "Economy Module (GS 3 Module) | Rajashree's IAS Portal",
    description: "Complete Economics preparation for GS Paper 3 covering Indian Economy, Agriculture, Industry, and Infrastructure for UPSC & MPSC exams.",
};

export default function EconomyModuleCoursePage() {
    const course = coursesData.courses.find(c => c.id === "economy-module");
