...
export const metadata: Metadata = {
    title: "Ethics Module (GS 4) | Rajashree's IAS Portal",
    description: "Complete Ethics, Integrity and Aptitude preparation for GS Paper 4 with case studies and value-based questions for UPSC & MPSC exams.",
};

export default function EthicsModuleCoursePage() {
    const course = coursesData.courses.find(c => c.id === "ethics-module");
