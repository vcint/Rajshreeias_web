...
export const metadata: Metadata = {
    title: "Manthan – Test Series Module (Prelims) | Rajashree's IAS Portal",
    description: "Comprehensive Prelims test series with detailed analysis and performance tracking for UPSC & MPSC exams.",
};

export default function ManthanCoursePage() {
    const course = coursesData.courses.find(c => c.id === "manthan");
