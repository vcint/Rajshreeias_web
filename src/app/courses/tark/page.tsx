...
export const metadata: Metadata = {
    title: "CSAT Module – Tark (तर्क) | Rajashree's IAS Portal",
    description: "Complete CSAT preparation covering comprehension, logical reasoning, and quantitative aptitude for UPSC & MPSC exams.",
};

export default function TarkCoursePage() {
    const course = coursesData.courses.find(c => c.id === "tark");
