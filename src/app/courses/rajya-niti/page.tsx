...
export const metadata: Metadata = {
    title: "Rajya Niti - The GS 2 Module | Rajashree's IAS Portal",
    description: "Complete GS Paper 2 preparation covering Governance, Constitution, Polity, and International Relations for UPSC & MPSC exams.",
};

export default function RajyaNitiCoursePage() {
    const course = coursesData.courses.find(c => c.id === "rajya-niti");
